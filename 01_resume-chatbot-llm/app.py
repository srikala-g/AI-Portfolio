...
if __name__ == "__main__":
    ...
    demo = gr.ChatInterface(
        ...
        description=(
            "Hello, you can have a conversation with me about my background and experience in the technology and art industry and ask me about any questions you may have.."
        ),
        theme="soft",
    )
demo.launch()
